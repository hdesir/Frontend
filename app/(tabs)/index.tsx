...
const renderCarousel = ({item}: CarouselProps) => (
    ...
    <ThemedView style = {[{flex: 1, overflow: "visible"},styles.container]}>
      <View style= {{flex: 1, overflow: "visible"}}>
        ...
        <Image style={
            [{height: 300, width: 410, resizeMode: "cover", padding: 0, marginTop: -10}, imageAnimatedStyle]}
          source={{uri: item.uri}}  /> 
...
<ThemedText type="subtitle" style= {{paddingBottom: 0, paddingRight: 15, paddingLeft:15, borderWidth: 0.5, borderColor: "#003566", borderRadius: 5, backgroundColor: "#c20114", marginBottom: 5}}>Trending in Sports</ThemedText>
      ...
      <ThemedView style={styles.stepContainer}>
      <ThemedText type="subtitle" style= {{paddingBottom: 0, paddingRight: 15, paddingLeft:15, borderWidth: 0.5, borderColor: '#003566', borderRadius: 5, backgroundColor: "#c20114"}}>Weekly News</ThemedText>
...
<ThemedText type="subtitle" style= {{paddingBottom: 0, paddingRight: 15, paddingLeft:15, borderWidth: 0.5, borderColor: '#003566', borderRadius: 5, backgroundColor: "#c20114"}}>Culture & Development</ThemedText>
         <ThemedView style={{ flex: 1, alignItems: "center", justifyContent: "center", top:0, overflow: "visible", width: "100%", padding: 50, zIndex: 100, backgroundColor: "black" }}>
          <Carousel style={{position:"relative", marginBottom: -50, top: -20, overflow: "visible", width: 350, backgroundColor: "#003566", height: 350, alignItems: "center", justifyContent: "center", zIndex:50, borderRadius: 360, borderWidth: 0.5}}
        loop
        width= {360}
